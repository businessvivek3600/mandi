...
class LanguageEn extends BaseLanguage {
  ...
  @override
  String get lblWelcomeToHandyman => "Welcome To ${AppConst.appName}";

  @override
  String get lblWalkThroughSubTitle =>
      "${AppConst.appName} - On-Demand Home Services App with Complete Solution";
  ...
  String get lblWalkThrough0 =>
      "${AppConst.appName} - ${AppConst.appDescription} with Complete Solution";
