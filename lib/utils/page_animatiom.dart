...
class _OpenContainerState<T> extends State<OpenContainer<T?>> {
  ...
  Future<void> openContainer() async {
    ...
    Route<T> route = _OpenContainerRoute<T>(
    ...
    T? data;
    if (widget.replaceRoute) {
      data = await Navigator.of(context).pushReplacement(route);
    } else {
      data = await Navigator.of(context).push(route);
    }
